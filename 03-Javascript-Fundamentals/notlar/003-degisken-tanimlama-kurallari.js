// ********** Değişken Tanımlama Kuralları #3 ********** 
...
let fullName = "" // bu dogru :)
let kodluyoruzServerInfo = "" // bu dogru :)

let firstName = "Mert", lastName = "Kandemir" // aşağıdaki şekilde kullan
let firstName = "Mert"
let lastName = "Kandemir"
console.log(firstName, lastName)

// UPPER_CASE Kullanimi:
const password = "1234" // bu dogru kullanim degil :(
const PASSWORD = "1234" // bu dogru :)
...
let info = 'Türkçe Bilgi Yazdırılıyor..' // bu dogru :)
console.log(info)
